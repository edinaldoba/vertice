...
\node[scale=0.7] at (5/6*6, -0.3-0.00) {sáb};
  \draw[ultra thick, dashed, VermelhoLaser] (0*5/6, 3.0) -- (1*5/6, 2.5) -- (2*5/6, 1.0) -- (3*5/6, 1.5) -- (4*5/6, 0.5) -- (5*5/6, 2.0) -- (6*5/6, 0.0)  ;
  \draw[ultra thick, VerdeEscola] (0*5/6, 2.5) -- (1*5/6, 0.0) -- (2*5/6, 1.0) -- (3*5/6, 1.5) -- (4*5/6, 3.0) -- (5*5/6, 2.0) -- (6*5/6, 0.5)  ;
  \fill[VermelhoLaser] (0*5/6, 3.0) circle (2.5pt);
  \fill[VerdeEscola] (0*5/6, 2.5) circle (2.5pt);
  \fill[VermelhoLaser] (1*5/6, 2.5) circle (2.5pt);
  \fill[VerdeEscola] (1*5/6, 0.0) circle (2.5pt);
  \fill[VermelhoLaser] (2*5/6, 1.0) circle (2.5pt);
  \fill[VerdeEscola] (2*5/6, 1.0) circle (2.5pt);
  ...
  \fill[VerdeEscola] (4*5/6, 3.0) circle (2.5pt);
  \fill[VermelhoLaser] (5*5/6, 2.0) circle (2.5pt);
  \fill[VerdeEscola] (5*5/6, 2.0) circle (2.5pt);
  \fill[VermelhoLaser] (6*5/6, 0.0) circle (2.5pt);
...
na sexta e na quinta
na terça e no domingo
