...
\begin{tikzpicture}[>=latex, xscale=0.30, yscale=0.45]
  ...
  \draw[fill=VinhoDestaque!70] (0,0.5) rectangle node[right=0.450cm] {\bf\scriptsize 3} (3,1.5);
  \draw[fill=LaranjaAlerta!70] (0,2.0) rectangle node[right=0.750cm] {\bf\scriptsize 5} (5,3.0);
