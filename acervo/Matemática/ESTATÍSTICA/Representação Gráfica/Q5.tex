...
\begin{tikzpicture}[>=latex, xscale=0.30, yscale=0.45]
  ...
  \draw[fill=VinhoDestaque!70] (0,0.5) rectangle node[right=1.200cm] {\bf\scriptsize 8} (8,1.5);
  \draw[fill=LaranjaAlerta!70] (0,2.0) rectangle node[right=0.600cm] {\bf\scriptsize 4} (4,3.0);
  \draw[fill=VerdeEscola!70]   (0,3.5) rectangle node[right=0.900cm] {\bf\scriptsize 6} (6,4.5);
